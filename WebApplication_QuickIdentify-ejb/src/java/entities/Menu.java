...
public class Menu implements Serializable {
    ...
    private Collection<Agentcallcenter> agentcallcenterCollection;
    ...
    @XmlTransient
    public Collection<Agentcallcenter> getAgentcallcenterCollection() {
        return agentcallcenterCollection;
    }

    public void setAgentcallcenterCollection(Collection<Agentcallcenter> agentcallcenterCollection) {
        this.agentcallcenterCollection = agentcallcenterCollection;
    }
